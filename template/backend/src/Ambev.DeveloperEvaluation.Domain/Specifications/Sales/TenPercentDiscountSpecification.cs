...
{
    /// <summary>
    /// Regra de negócio: aplica desconto de 10% se uma venda tiver pelo menos 10 itens totais.
    /// </summary>
    public class TenPercentDiscountSpecification : ISpecification<Sale>
    {
